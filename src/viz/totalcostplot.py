"""Script to produce Fig.5., showing the total entropy production costs and the overdamped
and wasserstein-2 distance bound """
...
if __name__=="__main__":
  ...
  plt.plot(df_ep_cost_all[df_ep_cost_all.Tf==2].g,(1+df_ep_cost_all[df_ep_cost_all.Tf==2].g)*df_ep_cost_all[df_ep_cost_all.Tf==2].ODBound,linestyle="dashed",label=r"$\mathcal{W}_2$-distance")#,yerr=0.04,ecolor="black",capsize=4,elinewidth=1,label=r"EP cost $\pm 0.04$")
  ax = plt.gca()
  format_log_axes(ax)
  ...
  plt.plot(df_ep_cost_all[df_ep_cost_all.Tf==50].g,(1+df_ep_cost_all[df_ep_cost_all.Tf==50].g)*df_ep_cost_all[df_ep_cost_all.Tf==50].ODBound,linestyle="dashed",label=r"Squared $\mathcal{W}_2$-distance")#,yerr=0.04,ecolor="black",capsize=4,elinewidth=1,label=r"EP cost $\pm 0.04$")
  ax = plt.gca()
  format_log_axes(ax)
  ax.set_xlabel(r"$g$")
  ...
  green_line = mlines.Line2D([], [],color="green",linestyle="dashed")
