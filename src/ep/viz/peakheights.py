"""Script to produce Fig.6., the heights of the overdamped and underdamped distribution
peaks over the time horizon """
...
if __name__=="__main__":
  ...
  for peaks in enumerate([f1,f2,f3]):
    ...
    ax.plot(times_t0_temp,height_a,color=c1,label = "Underdamped")
    ax.plot(times_t0_temp,height_b,color=c1)
    ax.plot(times_t0_temp,ODheight_a,color = "orange",label = "Overdamped")
    ax.plot(times_t0_temp,ODheight_b,color = "orange")
    #plt.ylim((0.25,0.45))
    ...
    ax2.scatter(times_t0_temp,loc_a,color=c1,label = "Underdamped")
    ax2.scatter(times_t0_temp,loc_b,color=c1)
    ax2.scatter(times_t0_temp,ODloc_a,color = "orange",label = "Overdamped")
    ax2.scatter(times_t0_temp,ODloc_b,color = "orange")
