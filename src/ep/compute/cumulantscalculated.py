...
def compute_and_save_predicted_cumulants(gs,bridgetype="full"):
  """
  ...
  for gi in gs:
    pos_var_temp = [cumulants.position_variance_g(t0,gi) for t0 in times_t0]
    x_corr_temp = [cumulants.cross_correlation(t0,gi) for t0 in times_t0]
    mom_var_temp = [cumulants.momentum_variance(t0,gi) for t0 in times_t0]
    mom_mean_temp = [cumulants.mom_mean(t0,gi) for t0 in times_t0]
    pos_mean_temp = [cumulants.linear_position_cumulant(t0,gi) for t0 in times_t0]
