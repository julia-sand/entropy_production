...
plot_pair(times_t0[1],"$\mathrm{t} = 1/8\ \mathrm{t}_f$",["(b)","(g)"],gs0,1)
plot_pair(times_t0[2],"$\mathrm{t} = 1/4\ \mathrm{t}_f$",["(c)","(h)"],gs0,2)
plot_pair(times_t0[-1],"$\mathrm{t} = 3/8\ \mathrm{t}_f$",["(d)","(i)"],gs0,3)
